...
> **Historical protocol.** The Dense model and pretraining launcher used by
> this runbook were removed. Commands on this page are preserved for evidence
> provenance and do not run against the current framework checkout.
