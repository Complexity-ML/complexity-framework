...
- Muon: Momentum Orthogonalized by Newton-Schulz (see muon.py)
    ...
    **kwargs,
    ...
    for name, param in model.named_parameters():
        if not param.requires_grad:
            continue
        # No weight decay for bias, normalization, and embedding parameters.
    ...
    if optimizer_type.lower() not in optimizer_map:
        raise ValueError(
            ...
            f"Available: {list(optimizer_map.keys()) + ['muon']}"
        )
