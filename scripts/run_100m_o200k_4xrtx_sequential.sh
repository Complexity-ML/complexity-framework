...
TR_CONFIG="$REPO_ROOT/configs/run_configs/100m_o200k_chinchilla/tr_gqa_frequency_balanced_seed42_2b_b200.yaml"
...
run_model() {
  ...
  case "$architecture" in
    ...
    tr)
      config="$TR_CONFIG"
      run_name="tr-gqa-frequency-balanced-100m-o200k-2b-s42-b24"
      master_port=29602
      ;;
    *)
