...
def make_config() -> ModelConfig:
    ...
    hidden=1024, layers=20, heads=16, kv_heads=4, inter=3240, 4 experts
    shared=810, expert=810 → ~387M (matches run2 shared=expert ratio).
    """
    return ModelConfig(
        hidden_size=1024,
