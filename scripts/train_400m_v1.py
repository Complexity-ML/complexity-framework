...
def make_config() -> ModelConfig:
    ...
    hidden=1024, layers=20, heads=16, kv_heads=4, inter=3344, 4 experts
    shared_intermediate_size=1011 → ~353M (42% active/dense ratio, matches run2).
    """
    return ModelConfig(
        hidden_size=1024,
