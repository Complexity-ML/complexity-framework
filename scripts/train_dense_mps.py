...
Usage:
    python scripts/train_dense_mps.py --steps 1000 --bf16 --dataset fineweb
...
def make_config() -> ModelConfig:
    # intermediate_size=3840 tuned to land near 105M total params,
    # matching the MoE recipe for a fair iso-params comparison.
    return ModelConfig(
        hidden_size=640,
