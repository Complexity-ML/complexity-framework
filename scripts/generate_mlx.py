#!/usr/bin/env python
"""Generate text with the converted MLX ComplexityModel using the project tokenizer.

This script uses the local Complexity tokenizer (`complexity.tokenizer.Tokenizer`)
with the MLX model generated by `scripts/convert_to_mlx.py`.
"""
